...
export default function Zoo() {
   ...
   const handleSpecies = (e) => {
      let newAnimals = zoo.allAnimals.filter((animal) => animal.specie === e.target.innerHTML);
      setZoo({
         ...zoo,
         animals: newAnimals
      });
   ...
   return (
      <div>
         ...
         <input type="text" name="name" id="name" value={zoo.zooName} onChange={handleInputChange} />
         <h1>{zoo.zooName}</h1>
